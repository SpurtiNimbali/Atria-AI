                  ...
                  {commits.map((commit, index) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <h4 className="text-sm mb-1.5 relative z-10 font-medium" style={{ color: "#e6edf3" }}>{commit.title}</h4>
                        <div className="text-xs relative z-10 leading-relaxed" style={{ color: "#8b949e" }}>
                          {commit.summary.split('\n').map((line: string, idx: number) => (
                            <p key={idx} className="mb-0.5 break-words" style={{ wordWrap: "break-word", overflowWrap: "break-word" }}>
                              {line}
                            </p>
                          ))}
                        </div>
