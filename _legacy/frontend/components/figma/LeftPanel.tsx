...
export function PatientContext({ patient, onCitationClick }: PatientContextProps) {
  const vitalsData = {
  ...
  return (
    <div className="w-80 h-full p-6 flex flex-col gap-4 overflow-y-auto relative" style={{ fontFamily: "'Crimson Pro', serif" }}>
      <div
