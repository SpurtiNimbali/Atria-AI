...
os.environ.setdefault("JINA_API_KEY", "jina_df357fda5d5d41f580b595e80f8920c8HS4s_-a69Vtry9OyS0YLQ_VUL1iX")
os.environ.setdefault("OPENAI_API_KEY", "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")
...
def ingest_synthetic_patient(json_file: str):
    ...
    print()
    print("Next steps:")
    print("  1. Start the gateway: cd ../gateway && uvicorn main:app --reload")
